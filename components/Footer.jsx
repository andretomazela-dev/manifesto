  ...
  return (
    <footer className="bg-[#FF4D00] text-white py-10 px-6">
      <div className="flex flex-col items-center text-center space-y-3">
        ...
        <a href="mailto:andre@andretomazela.com.br" className="text-sm hover:underline break-all">
          andre@andretomazela.com.br
        </a>

        <div className="flex justify-center gap-6 mt-2">
          <a href="https://wa.me/message/TUNCL3KFQIECM1" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="hover:opacity-80 transition">
            <IconWhatsApp />
          </a>
          <a href="https://www.linkedin.com/in/tomazela/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:opacity-80 transition">
            <IconLinkedIn />
          </a>
          <a href="https://www.instagram.com/andretomazela/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:opacity-80 transition">
            <IconInstagram />
          </a>
        </div>
      </div>
