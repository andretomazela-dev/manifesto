...
export default function Home() {
  ...
  // Carrega e renderiza o Turnstile
  useEffect(() => {
    if (typeof window === "undefined" || !TURNSTILE_SITE_KEY) return;

    // callback global (também setado no render options)
    ...
    const renderWidget = () => {
      ...
      host.innerHTML = ""; // evita widget duplicado em hot reload
    ...
    // Fallback: se o widget não der token em até 3s, libera envio
